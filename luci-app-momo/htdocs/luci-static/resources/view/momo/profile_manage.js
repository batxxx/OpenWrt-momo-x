...
function renderUploadPanel(paths) {
    let input;
...
return view.extend({
    ...
    render: function (data) {
            ...
            for (const row of rows) {
                    ...
                    if (row.value && !row.missing) {
                        ...
                        actions.push(button('切换', 'positive', function () {
                            return momo.setProfile(row.value);
                        }));
                    }
                    ...
                    if (row.deletable) {
                        ...
                        actions.push(button('删除', 'negative', function () {
                            ...
                            return momo.removeFile(row.path);
                        }));
                    }
        ...
        const table = E('div', { 'class': 'cbi-section' }, [
            E('h3', {}, '配置文件列表'),
